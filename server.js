...
const path = require("path") //allow us to work with file paths //helped functions for file paths 

///////////////
//Establish Database Connection
///////////////
//setup the inputs from mongoose connect
...
app.get("/fruits", (req,res) =>{
    //find all the fruits 
    Fruit.find({}) //passing na empty objects find ALL
    .then((fruits) => {
...
app.post("/fruits", (req,res) => {
    ...
    req.body.readyToEat = req.body.readyToEat === "on" ? true : false //using ternary operator 
